        ...
        <div className="grid grid-cols-12 gap-4 h-84.5vh ml-4 sm:mx-12 md:mx-16">
          <div className="col-span-12 md:col-span-7 lg:col-span-6 flex flex-col justify-center items-center">
            ...
            <div className="items-center w-3/4 -mt-10 relative">
              ...
              />
              <HeaderSmall text="Who is Prohar?" />
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-none xl:grid-cols-2 gap-4 mt-6">
                ...
                <div className="sm:col-span-1 xl:col-span-1">
                  <a
                    href="/resume.pdf"
                    download
                    className="font-regular px-6 sm:px-4 xl:px-6 py-4 w-64 sm:w-52 md:w-56 2xl:w-60 text-7xl h-25 transition-all rounded overflow-hidden border-2 border-pink text-pink bg-transparent hover:bg-pink hover:text-blue hover:shadow-light-xl flex items-center justify-center">
                    Download Resume
                  </a>
                </div>
              </div>
